...
if(toComputePWMScores){
	...
	if(file.exists("objects/BindingEnergyAtLociAccessibilityRegionsWeakBinding.RData")){
		load("objects/BindingEnergyAtLociAccessibilityRegionsWeakBinding.RData");
        } else{
		...
		save(bindingEnergy, file=paste("objects/BindingEnergyAtLociAccessibilityRegionsWeakBinding.RData",sep=""));
...
if(toComputeOccupancy){
	...
	if(file.exists("objects/occupancyAllTFsAllPositiveAccessibilityRegionsWeakBinding.RData")){
		load("objects/occupancyAllTFsAllPositiveAccessibilityRegionsWeakBinding.RData");
        } else{
		...
		save(occupancy, file=paste("objects/occupancyAllTFsAllPositiveAccessibilityRegionsWeakBinding.RData",sep=""));
